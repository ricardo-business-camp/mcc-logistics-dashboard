...
function App() {
  ...
  const [orders, setOrders] = useState([
    ...
    { status: 'ON-TIME', cutoff: '5:30 PM', timeLeft: '5 hrs 40 mins', city: 'CHICAGO', delivery: '5876543', job: '4007654', product: 'BROCHURES TRI-FOLD', production: 'DIECUTTING', timeInStatus: '1:05', receipted: 0, orderQty: '150,000', jobStart: '04/02/26 6:45 AM', jobFinish: '04/02/26 9:15 AM', dueDate: '04/02/26 5:30 PM', customer: 'ProPrint Group', readyPercent: 85, truck: 'SHUTTLE-Q3', warehouse: 'MCC PLANT' }
  ]);
